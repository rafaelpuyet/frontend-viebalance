export default function Footer() {
  return (
    <footer className="bg-cream-white text-cream-beige py-10 px-6 md:px-10">
      <div className="max-w-5xl mx-auto text-center">
        <div className="flex items-center justify-center gap-3 mb-4">
          <img alt="Vie Balance Logo" className="h-10 w-10 rounded-lg object-cover border-terracotta"
            src="/logo.png" loading="lazy" />
          <h3 className="text-2xl font-bold text-cream-white">Vie Balance</h3>
        </div>
        <p className="text-sm mb-2">Nutriendo mente y cuerpo a través del arte del Pilates en Las Condes.</p>
        <p className="text-sm mb-6">
          Correo electrónico: <a className="hover:text-accent-orange transition-colors"
            href="mailto:info@viebalance.cl">info@viebalance.cl</a>
        </p>
        <div className="flex justify-center space-x-4 mb-6">
          <a className="text-cream-beige hover:text-accent-orange transition-colors" href="#">
        ...
        <p className="text-xs">© 2025 Vie Balance. Todos los derechos reservados. <a
            className="hover:text-accent-orange transition-colors" href="#">Política de Privacidad</a> | <a
            className="hover:text-accent-orange transition-colors" href="#">Términos de Servicio</a></p>
      </div>
    </footer>
  );
}